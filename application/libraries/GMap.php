...
class Gmap {
	...
	*/
    ...
    function getMapJS() {
        ...
        $_output .= " * Author: Subhanarayan Mohapatra <WebInfoMart.com>\n";
        $_output .= " * Link http://code.google.com/p/phpgooglemapapiv3/\n";
        $_output .= " * Copyright 2012 Subhanarayan Mohapatra\n";
        $_output .= " * Original Author: Subhanarayan Mohapatra <WebInfoMart.com>\n";
        $_output .= " * Original Copyright 2012 WebInfoMart.com\n";
    ...
    function getMap() {
        ...
        if(strlen($this->width) > 0 && strlen($this->height) > 0) {
            $_output .= sprintf('document.write(\'<div id="%s" style="width: %s; margin-top:2px; height: %s; position:relative;"><\/div>\');',$this->map_id,$this->width,$this->height) . "\n";
        } else {
