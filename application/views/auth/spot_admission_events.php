		...
		<div class="body">
			...
			<div class="modal" id="show_success" style="display:none;" >
				...
				<div class="float_l span13 margin_l">
					...
					<div id="loading_img" style="z-index:-1;margin-top: 139px;margin-top: 139px;margin-left: 260px;position: absolute;"> <img src="<?php echo "$base$img_path"; ?>/AjaxLoading.gif"/> </div>
...
<SCRIPT LANGUAGE="JavaScript">     
 ...
 /* $('#myModal').modal({
  ...
  $.ajax({
	   ...
	   {
	   $('#event_det').html(msg);
		$('#sms_form').append('<input type="hidden" name="page_status" value="spot"/>');
		$('#myModal').modal({
        keyboard: false
    })
