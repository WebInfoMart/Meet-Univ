				...
				<div class="span16 margin_zero">
					<div class="float_l span3 margin_zero sidebar">
						<div class="margin_t50 single_sidebar">
							<ul>
								<li><div class="float_l"><a href="<?php echo "$base" ?>update_profile"><img src="<?php echo "$base$img_path";  ?>/account.png" class="margin_l"></div><div class="float_l margin_l">Account Information</div></a><div class="clearfix"></div></li>
								<li class="active_side"><div class="float_l"><img src="<?php echo "$base$img_path";  ?>/update.png" class="margin_l"></div><div class="float_l margin_l">Update Password</div><div class="clearfix"></div></li>
