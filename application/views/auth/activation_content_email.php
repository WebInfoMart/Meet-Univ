   ...
   <tbody><tr>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
     ...
     <tr>
	  ...
	  <?php 
	  echo "<h3>Dear &nbsp;".$fullname['fullname']."</h3>";
	  ?>
	  <span ><h3>
	 	Thanks for registering at Global University Events | MeetUniversities.com!<br />
		We are glad you have chosen to be a part of our community and we hope<br />
		you enjoy your stay.<br />

		All the best,<br />
		Global University Events – One Place  | MeetUniversities.com<br />
