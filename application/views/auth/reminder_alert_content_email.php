   ...
   <tbody><tr>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
     ...
     <tr>
	  ...
	  echo "<div style='float:left;'><span style='color:red'>Response to your Event Listing on MeetUniversities.</span>";
	  echo "<h3>Let&nbsp;$fullname remember this for you and personally call you to remind about the event
	  </h3></br>";
	  echo "You have received a 'Engage Request' for your Event ID: $event_id from a prospective student.</div>";
	  
	  ?>
	  <div style='float:right;'> <img src="<?php echo base_url(); ?>images/grammargirlavatar.jpg" style='width: 180px;height: 170px;'/>
	  <span style="color:red;"><h3> </h3> </br></br></br>
		   <p> Emails for </br> Event Registrations</p> 
		   </span></div>
	  <u></u><u></u></span></p>
      </td>
     </tr>
