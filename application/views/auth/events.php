							...
							<div id="event1" class="">
								...
								<h4><?php echo $event_detail['cityname'].",".$event_detail['statename'].",".$event_detail['country_name']?> </a></h4>
										 	...
										 	<div>
												...
												<div id="fb" class="float_l fb"><div class="fb-like" data-href="<?php echo $base;?>univ-<?php echo $event_detail['univ_id']; ?>-event-<?php echo $event_detail['event_id']; ?>" data-send="false" data-layout="button_count" data-width="20" data-show-faces="true" data-font="arial" style="width:48px;"></div></div>
									...
									<?php } } else { echo "No Recent Events Found ..."; }  ?> <!--print_r($array_dates);-->
							</div> 
