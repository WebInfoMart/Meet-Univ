				...
				<div class="margin_zero span16 margin_ts">
					<div class="span3 margin_zero float_l">
						<div class="sidebar_profic_pic">
							<img src="http://workforcetrack.in/uploads/Taj_Mahal.jpg">							
							<h3 class="text_align">bhatias</h3>
							<div>
								<div class="margin_all">
									<h4 class="text_align">02 Aug 2012,Female</h4>
								</div>
							</div>
						</div>
						...
						<div class="part_second font_sidebar">
							<div class="index_sidebar_content invite">
								<div class="index_sidebar_header">
									<a id="pulse2" href="#myModal2" data-toggle="modal"><span class="orange"><img src="images/mail.png"> &nbsp; Send Message</span></a>
								</div>
							</div>
