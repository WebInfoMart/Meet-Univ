						...
						<div>
							<ul class="event_new">
								...
								if(!empty($featured_events))
								{
									...
									{ 																						$univ_domain=$home_feature_event['subdomain_name'];																		$event_link_register=$this->subdomain->genereate_the_subdomain_link($univ_domain,'event','','');																				$cc++;																	if($cc==4)																break;
								...
								?>
								<li>					<form action="<?php echo $event_link_register; ?>/EventRegistration" method="post" class="margin_zero">																	
									<div class="event_meth float_l">
										...
										<div class="margin_t1">
											...
											//echo substr($event_detail,0,180); ?>																		<input type="hidden" name="event_register_of_univ_id" value="<?php echo $home_feature_event['univ_id']; ?>"/>														<input type="hidden" name="event_register_id" value="<?php echo $home_feature_event['event_id']; ?>"/>																<input type="submit" name="btn_event_register" id="<?php echo $home_feature_event['event_id']; ?>" value="Register" class="btn btn-success" />								
										</div>																				</form>
									</div>
									<div class="float_r">
