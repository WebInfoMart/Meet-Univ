...
<div class="container">
	...
	<div class="fb-like" style="width: 66px;" data-href="<?php echo $base;?>univ-<?php echo $event_detail['univ_id']; ?>-event-<?php echo $event_detail['event_id']; ?>" data-send="false" data-layout="button_count" data-width="20" data-show-faces="true" data-font="arial"></div>
									...
									<span style="margin-right: 12px;"><g:plusone size='medium' id='shareLink' annotation='none' href='<?php echo $base;?>univ-<?php echo $event_detail['univ_id']; ?>-event-<?php echo $event_detail['event_id']; ?>' callback='countGoogleShares' data-count="true"></g:plusone></span>
...
//'12/04/2012';
		  ...
		  <?php echo $array_dates; ?>
					...
					$.ajax({
						type: "POST",
						url: searchUrl,
						data:'date='+x+"&month="+y+"&year="+z+"&type=counsell",
