   ...
   <tbody><tr>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
     ...
     <tr>
	  ...
	  <?php 
	  echo "<br />Dear &nbsp; Admin<br />";
	  ?>
	  <span ><b><?php echo ucwords($fullname);?></b> has asked a <a href="<?php echo $url; ?>" target="_blank">question</a>.<br /><br />
		   Please visit the <a  target="_blank" href="<?php echo $url; ?>">link</a> to read <b><?php echo ucwords($fullname);?>'s</b> question and also post on the thread .<br /><br />
		   If the above link does not work, please copy the below url and open it in your browser to view the Question.<br /><br />
		   <?php echo $url; ?>
		   </span></p>
      </td>
     </tr>
