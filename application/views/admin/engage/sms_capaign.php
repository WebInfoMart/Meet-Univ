...
<body>
	...
	<div class="body">
		<div class="big_Width second_set">
			<div class="float_l span8 margin_delta">
				...
				<div class="span7 margin_delta one_more">
					...
					<form class="form-horizontal margin_t">
						<div class="control-group2">
							...
							<div class="dotted_width float_l dotted_line"></div>
						...
						<div class="control_form">
							<div class="controls-input-data">
							<textarea cols="4px" rows="3"></textarea>
							</div>
						</div>
						<div class="control_form">
							<div class="controls-input-data">
			...
			<div class="float_l span4 margin_4 mbl_bg">
