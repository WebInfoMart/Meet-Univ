		...
		<h2 class="margin">Update University</h2>
			...
			<div class="form span8" style="float:left;width:630px;">
				<ul>
					...
					<input type="text" value="<?php echo ucwords($univ_detail_update['fullname']).'('.$univ_detail_update['email'].')'; ?>"/>
					<?php } ?>
						</div>						
						</div>
					</li>
					<li>
						...
						<input type="text" value="<?php echo $univ_detail_update['country_name']; ?>" />										
									...
									<li>
										...
										<div class="float_l span3">      
											<input type="text" value="<?php echo $univ_detail_update['statename']; ?>" />
										</div>										
										</div>
									</li>
									<li>
										...
										<div class="float_l span3">
											<input type="text" value="<?php echo $univ_detail_update['cityname']; ?>" />
										</div>										
										</div>
									</li>
