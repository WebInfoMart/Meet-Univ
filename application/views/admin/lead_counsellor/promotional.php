...
<body>
	<header>
		<div class="span6 float_r margin2">
			<div class="float_l border_holder">
				...
				<span class="margin_l">Welcome <?php echo ucwords($this->session->userdata('admin_fullname')); ?></span>
			</div>
			<div class="float_l border_holder">
	...
	<div class="body">
		<div class="span12">
		<a href="<?php echo $base; ?>admin_counsellor/counsellor" style="float:right;">Counsellor</a>
			
			<div class="span12 promot_holder">
				<div class="promot_heading">
				Promote
				</div>
				<div class="pc_set"><img src="<?php echo $base; ?>images/images/pc_icon.png" class="inline pc_img_set">
					<span class="inline text_size">Promote your events / university using our super intelligent :</span>
					<div class="line_set"></div>
				</div>
				<div class="center_area">
					<div class="float_l span3 center_color margin_delta">
						<div class="bg_green">
							<img src="<?php echo $base; ?>images/images/sms.png" class="icon_img"/>
							<a href="<?php echo $base; ?>adminleads/sms_capaign" ><span class="icon_txt">SMS campaign</span>
						</div>
					...
					<div class="float_l span3 margin_delta center_color">
						<div class="bg_orange">
							<img src="<?php echo $base; ?>images/images/mail.png" class="icon_img"/>
							<span class="icon_txt">EMAIL campaign</span>
						</div>
						<div class="padding fix_height">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</div>
						<button type="button" class="promo_btn">View Plans & Pricing</button>
					</div>
					...
					<div class="float_l span3 margin_delta center_color">
						<div class="bg_blue">
							...
							<span class="icon_txt">VOICE campaign</span>
						</div>
						<div class="padding fix_height">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</div>
						<button type="button" class="promo_btn">View Plans & Pricing</button>
					</div>
			...
			<div class="span12 second_holder">
				<div class="promot_heading">
				Super Intelligent comparison
				</div>
					<div class="data_margin">
						<div class="span5 float_l margin_delta">
