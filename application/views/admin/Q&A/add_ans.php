...
?>
 ...
 <div id="content">
		<h2 class="margin">Edit news</h2>
		<div class="form span8">
			<form action="<?php echo $base; ?>adminnews/edit_news/<?php echo $news_detail['news_id']; ?>" method="post" class="caption_form" enctype="multipart/form-data">
				<ul>
					<li>
						<div>
							...
							<div class="float_l span3">
								<input type="text" size="30" class="<?php echo $class_title; ?>" name="title" value="<?php echo $news_detail['news_title']; ?>">
...
<option value="<?php echo $univ_detail->univ_id; ?>" <?php if($univ_detail->univ_id==$news_detail['news_univ_id']) { ?> selected <?php } ?> ><?php echo $univ_detail->univ_name; ?></option>
		...
		<span style="color: red;"> <?php echo form_error('university'); ?><?php echo isset($errors['university'])?$errors['university']:''; ?> </span>
					...
					-->
					<?php } else { ?>
	 				<input type="hidden" name="university" value="<?php echo $news_detail['news_univ_id']; ?>">
					<?php }?>
			...
			?>
					...
					<li>
						<div>
							...
							<div class="">
								<textarea rows="12" name="detail" class="wysiwyg" cols="103"><?php echo $news_detail['news_detail']; ?></textarea>
							</div>
							<div class="clearfix"></div>
						</div>
					</li>
