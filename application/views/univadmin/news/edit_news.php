      ...
      <div class="row-fluid">
        <div class="span12">
          ...
          <div class="content-box">
            <div class="row-fluid">
				<div class="span12">
					 <form class="form-horizontal" onsubmit="return addNews(this);" id="myform" action="<?php echo $base; ?>newadmin/admin_news/edit_news/<?php echo $news_detail['news_id']; ?>" method="post" enctype="multipart/form-data">
						<fieldset>
							<div class="row-fluid">
								<div class="span2">
									<div class="gallery">
								...
								<div class="span9">
									<div class="control-group margin_b">
										...
										<input type="text" name="title" id="title" style="display:none;"  class="input-xlarge inputElement" value="<?php echo $news_detail['news_title']; ?>">
									</div>
									</div>
								...
								<option value="<?php echo $univ_detail->univ_id; ?>" <?php if($univ_detail->univ_id==$news_detail['news_univ_id']) { ?> selected <?php } ?> ><?php echo $univ_detail->univ_name; ?></option>
								<?php } ?>
								</select>
								</div>
									</div>
									<?php } else{ ?>
	 			<input type="hidden" name="univ" value="<?php echo $news_detail['news_univ_id']; ?>">
					<?php }?>
					<input type="hidden" name="news_type" value="univ_news"/>
									<div class="control-group margin_b">
										<label  class="control-label"><b>Detail</b></label>
										<div class="controls">
										<div class="help-inline data1"> <?php echo $news_detail['news_detail'];?></div>
										<textarea  style="display:none;" name="detail" id="detail" class="span12 inputElement" rows="4"><?php echo $news_detail['news_detail'];?></textarea>
										</div>
									</div>
								</div>
