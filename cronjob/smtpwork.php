 ...
 */
	...
	$from="info@meetuniversities.com";                           /* Change this to your address like "me@mydomain.com"; */ 
	...
	$smtp->host_name="relay.mailserv.in"; //IP address       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
	...
	$smtp->user="relay@meetuniversities.com";                     /* Set to the user name if the server requires authetication */
	$smtp->realm="";                    /* Set to the authetication realm, usually the authentication user e-mail domain */
	$smtp->password="M^et4025";                 /* Set to the authetication password */
